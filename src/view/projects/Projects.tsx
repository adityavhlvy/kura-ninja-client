...
export const projectsData: ProjectCardProps[] = [
  ...
  },
  {
    ...
    description:
      "A comprehensive Next.js application designed to visualize geospatial data related to fertilizer distribution and requirements. It serves as a powerful dashboard for monitoring and analyzing data across different administrative levels (Province, Regency, District) in Indonesia.",
    techStack: [
      "Next.js 16",
      "TypeScript",
      "Tailwind CSS v4",
  ...
  },
  {
    ...
    description:
      "Web app turning real-time weather into absurd, funny one-liners. Collected data via Open-Meteo API, generated text with Meta-LLama-3-8B Instruct.",
    techStack: [
      "Vue 3",
      "Tailwind CSS",
      "Daisy UI",
  ...
  },
  {
    ...
    description:
      "Analyzed Twitter (X) and YouTube comments from the 2024 Vice Presidential debate to extract sentiment and topic trends.",
  ...
  },
  {
    ...
    description:
      "Interactive web app prototype for a tourism village. Designed UI components and consistent design system in Figma.",
