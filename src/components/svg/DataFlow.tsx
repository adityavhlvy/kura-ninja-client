                ...
                {paths.map((path, i) => (
                    <g key={`flow-${i}`}>
                        ...
                        <motion.circle
                            ...
                            transition={{ duration: durations[i], delay: delays[i], repeat: Infinity, ease: "linear" }}
                        />
                        {/* Glow */}
                        <motion.circle
                            r="6"
                        ...
                        <motion.circle
                            ...
                            initial={{ offsetDistance: "0%" }}
                            animate={{ offsetDistance: "100%" }}
                            transition={{ duration: durations[i], delay: delays[i] + 0.4, repeat: Infinity, ease: "linear" }}
                        />
                    </g>
                ))}
            </svg>
